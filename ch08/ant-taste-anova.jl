...
using HypothesisTests,GLMakie,CSV,DataFrames,Distributions,RCall

df= (let str="SandwichAnts"
    df=load_data(str)
...
function anova_test()
    ...
    sample=DataFrame(group1=gdf[1][!,:Ants],group2=gdf[2][!,:Ants],group3=gdf[3][!,:Ants])
