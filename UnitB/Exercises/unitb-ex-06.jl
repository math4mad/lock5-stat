...
# 4. Is the proportion of couples for which the husband is older greater than 50%?
  morethan0=filter(x->x>0,data.age_diff)|>length
  total=length(data.age_diff)
  "husband is older ratio"=>"$(ratio1=morethan0/total*100)%"
